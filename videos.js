/* ==========================================================================
   Video Lessons: reads /videos/manifest.json. Leave videoId empty and it
      ...
      <div class="card">
        ...
        ${v.videoId
          ...
          : `<div class="placeholder-block" style="padding:24px; margin-top:12px;">
               <p style="margin:0; font-size:0.85rem;">No video linked yet - add a YouTube video ID to this entry in videos/manifest.json.</p>
             </div>`}
      </div>
    `).join('');
  } catch (e) {
